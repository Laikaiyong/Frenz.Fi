 ...
 */
export default async function useGetGeneralCurrentValue(addresses, chainId, useCache) {

    try {
        const response = await fetch("https://api.1inch.dev/portfolio/portfolio/v4/general/current_value", {
            method: "GET",
            headers: {
