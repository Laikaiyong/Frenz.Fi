        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold mb-2">
              {tokenData.name}
              <span className="ml-2 text-gray-500 text-xl">{tokenData.symbol}</span>
            </h1>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-xl p-6">
            ...
            {activeTab === 'forum' && (
              <div className="space-y-4">
                {isHodler ? (
                  forumPosts.map((post) => (
                    <div key={post.id} className="p-4 border border-gray-200 rounded-lg hover:border-[#0052FF] transition-all">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-gray-600">Total Liquidity: {tokenData.liquidity}</p>
                  </div>
